...
define( 'WPCACHEHOME', '/usr/local/openresty/nginx/html/codezhai/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'codezhai_wordpress');
