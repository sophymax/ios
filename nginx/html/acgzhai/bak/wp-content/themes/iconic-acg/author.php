	...
	<section id="primary" class="site-content">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="archive-header">
				<h1 class="archive-title"><?php if(get_the_author()!='jiecao'){ printf( __( 'Author Archives: %s', 'themonic' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );}else{echo urldecode('%E6%97%A0%E8%8A%82%E6%93%8D%E7%9A%84Code%E5%AE%85');}?></h1>
