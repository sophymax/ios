...
jQuery(document).ready(function($) {
	...
	// ARCHIVES PAGE
	$('.archivelist ul li a').attr({target:"_blank"});$('.archivelist ul').hide();$('.archivelist ul:first').show();$('.archivelist:eq(0)> h3').click(function(){$(this).next().slideToggle(300);});
	$('.arc-collapse').toggle(function(){$(this).text("折叠所有月份");$('.archivelist ul').slideDown(300);},function(){$(this).text("展开所有月份");$('.archivelist ul').slideUp(300);});
