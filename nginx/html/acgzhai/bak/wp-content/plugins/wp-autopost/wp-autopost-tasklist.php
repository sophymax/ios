...
elseif($saction=='editSubmit'){
 ...
 if($charset==0)$page_charset='UTF-8';
...
<?php endif; ?>
       ...
       <tr>
        ...
        <td>
		   <input class="charset" type="radio" name="charset" value="0"  <?php if($config->page_charset=='UTF-8') echo 'checked="true"'; ?>> UTF-8 
		   <input class="charset" type="radio" name="charset" value="1"  <?php if($config->page_charset!='UTF-8') echo 'checked="true"'; ?>> <?php echo __('Other','wp-autopost'); ?>
		   <span id="ohterSet" <?php if($config->page_charset=='UTF-8') echo 'style="display:none;"' ?>><input type="text" name="page_charset" id="page_charset"  value="<?php if($config->page_charset!='UTF-8') echo $config->page_charset; ?>"></span>		   
		</td> 
	   </tr>
...
<div class="postbox">
  ...
  <div class="inside" <?php if(!$showBox2)echo 'style="display:none;"' ?>>
	 ...
	 <h4><?php echo __('Article URL matching rules','wp-autopost'); ?></h4>
	  ...
	  <br/> 
	  <h4><input type="checkbox" name="post_filter" id="post_filter" /> <?php echo __('Article Filtering','wp-autopost'); ?></h4>
	  ...
	  <input type="radio" name="af0" value="0" checked="true" disabled="true" /> <?php echo __('<strong>Only Extract</strong> when title contains following keywords','wp-autopost'); ?> 
	  &nbsp;
	  <input type="radio" name="af0" value="1" disabled="true" /> <?php echo __('<strong>Do Not Extract</strong> when title contains following keywords','wp-autopost'); ?> 
      <br/>
	  <br/>
	  ...
	  <tr> 
		...
		<td>
		  <select id="post_method" name="post_method" >
            <option value="-1" ><?php echo __('Only Post Translated Text','wp-autopost'); ?></option>
		    <option value="1"  ><?php echo __('Post Original And Translated Text','wp-autopost'); ?></option>
		  </select>
		</td>
	  </tr>

	  <tr id="translated_cat"  style="display:none;" >
       <td> 
...
<div class="postbox">
  ...
  <div class="inside" <?php if(!$showBox4)echo 'style="display:none;"' ?> >
	...
	<table  id="OptionType5" width="100%">
    <thead>
     <th width="40%"><?php echo __('CSS Selector','wp-autopost'); ?></th>
     <th width="40%"></th>
     <th width="20%"></th>
    </thead>
...
<div class="postbox">
  ...
  <div class="inside" <?php if(!$showBox6)echo 'style="display:none;"' ?> >
   <p><span class="gray">(<?php echo __('For example','wp-autopost'); ?>, <b><?php echo __('Keyword','wp-autopost'); ?></b> : <i>wordpress</i> &nbsp;&nbsp;<b><?php echo __('Replace With','wp-autopost'); ?></b> : <i>&lt;a href="http://wordpress.org/">wordpress&lt;/a></i> )</span></p>            
...
function createExample(){
  ...
  global $wpdb,$t_f_ap_cnofig,$t_f_ap_config_ur1_1ist;
